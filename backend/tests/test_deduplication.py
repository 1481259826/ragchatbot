...
class TestSourceDeduplication:
    ...
    def test_search_tool_deduplicates_sources(self):
        ...
        assert (
            len(tool.last_sources) == 1
        ), f"Expected 1 source, got {len(tool.last_sources)}"
    ...
    def test_search_tool_keeps_different_lessons(self):
        ...
        assert (
            len(tool.last_sources) == 2
        ), f"Expected 2 sources, got {len(tool.last_sources)}"
    ...
    def test_outline_tool_deduplicates_links(self):
        ...
        assert (
            len(tool.last_sources) == 3
        ), f"Expected 3 sources, got {len(tool.last_sources)}"
