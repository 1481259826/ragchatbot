...
class TestRAGSystemIntegration:
    ...
    def test_query_with_tool_execution_flow(self, rag_system):
        ...
        rag_system.vector_store.get_lesson_link = Mock(return_value="http://example.com/mcp/lesson1")
    ...
    def test_query_without_tool_use(self, rag_system):
        ...
        rag_system.ai_generator.client.messages.create = Mock(return_value=mock_response)
    ...
    def test_query_with_session_management(self, rag_system):
        ...
        second_call_args = rag_system.ai_generator.client.messages.create.call_args_list[1]
    ...
    def test_query_with_lesson_filter(self, rag_system):
        ...
        final_response = MockResponse(
            content=[MockTextBlock(text="Lesson 3 covers...")],
            stop_reason="end_turn"
        )
    ...
    def test_sources_reset_after_query(self, rag_system):
        ...
        final_response = MockResponse(
            content=[MockTextBlock(text="Answer")],
            stop_reason="end_turn"
        )
